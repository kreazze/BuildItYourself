            ...
            <div className='learnmore_body'>
                <Carousel>
                    ...
                    <Carousel.Item id='carouselImages'>
                            ...
                            <Carousel.Caption id='carouselText'>
                                <h2>Monitor</h2>
                                <p>a display screen that provides visual output from a computer</p> <br/>
                            </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item id='carouselImages'>
                            <img
                            ...
                            <Carousel.Caption id='carouselText'>
                                <h2>Keyboard</h2>
                                <p> putting information including letters, words and numbers into your computer</p> <br/>
                            </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item id='carouselImages'>
                            <img
                            ...
                            <Carousel.Caption id='carouselText'>
                                <h2>Mouse</h2>
                                <p>is a small, movable device that lets you control a range of things on a computer</p> <br/>
                            </Carousel.Caption>
                    </Carousel.Item>
                </Carousel>
